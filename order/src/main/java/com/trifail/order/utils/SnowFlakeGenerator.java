...
public class SnowFlakeGenerator {
    ...
    private final static long START_EPOCH = 1512057600000L;
    ...
    public synchronized long nextId() {
        ...
        return (currStmp - START_EPOCH) << TIMESTMP_LEFT //时间戳部分
    ...
    private static class SnowFlakeHolder{
        private static SnowFlakeGenerator INSTANCE = new SnowFlakeGenerator();
    }
